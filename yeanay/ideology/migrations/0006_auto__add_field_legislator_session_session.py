...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'legislator_session.session'
        db.add_column(u'ideology_legislator_session', 'session',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'legislator_session.session'
        db.delete_column(u'ideology_legislator_session', 'session')
